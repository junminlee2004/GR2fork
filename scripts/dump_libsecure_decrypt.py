...
#
# USAGE (PyGhidra only; close the Ghidra GUI first):
#   Run under PyGhidra so `program` is defined (or prepend a header that sets it), then:
#     & "C:\Users\Administrator\AppData\Local\Programs\Python\Python313\python.exe" `
#       "C:\Users\Administrator\PS4RE\dump_libsecure_decrypt.py"
#
# FAST PATH for (1) — no Ghidra needed, the lib name is already in the table:
...
# Ghidra addresses (image base 0x107BF0). Both call sceLibSecureCryptographyDecrypt.
...
print("Open libsecure_decrypt_dump.txt — the call to the decrypt thunk")
