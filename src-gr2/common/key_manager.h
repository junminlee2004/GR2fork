...
// The vector<u8> serializer must be declared before the NLOHMANN_DEFINE_TYPE macros below,
// which serialize TrophyKeySet::ReleaseTrophyKey (a vector<u8>) - otherwise it is
// "specialization after instantiation", a hard error on some nlohmann/compiler versions.
namespace nlohmann {
template <>
