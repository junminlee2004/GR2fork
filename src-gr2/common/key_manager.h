...
// ------------------- NLOHMANN serializers -------------------
// The vector<u8> serializer MUST be declared before the NLOHMANN_DEFINE_TYPE
// macros below, which serialize TrophyKeySet::ReleaseTrophyKey (a vector<u8>):
// a template specialization has to be visible before the template is used,
// otherwise it is "specialization after instantiation" (a hard error on some
// nlohmann / compiler versions).
namespace nlohmann {
template <>
