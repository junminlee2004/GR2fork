...
// Raw button snapshot for external consumers (e.g. gallery HLE research). Accumulates presses
// from scePadRead/scePadReadState and an SDL event watcher installed lazily on first scePadRead;
// values match OrbisPadButtonDataOffset except L1=0x100 and R1=0x200.
