...
// GR2FORK FIX: use _WIN32, not WIN32. MSVC and clang-cl always define _WIN32; plain WIN32 is only
// defined when explicitly passed on the command line, so it is not guaranteed.
#ifdef _WIN32
