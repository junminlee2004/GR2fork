...
// Generates photo GNFs matching film_dummy.gnf exactly: 512x512 BC1 (data_format=41), Thin1DThin
// (tiling_index=13), 262400 bytes (256 header + 262144 pixel data), NumTextures=2 with the
// second T# all zeros.
...
// Thin1DThin micro-tiler for BC1: a micro-tile is 8x8 elements, one element = one BC1 block =
// 8 bytes, so a micro-tile is 512 bytes.
