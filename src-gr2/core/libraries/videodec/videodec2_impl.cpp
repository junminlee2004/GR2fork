...
s32 VdecDecoder::Decode(const OrbisVideodec2InputData& inputData,
    ...
    while (true) {
        ...
        // Pre-fill the frame buffer with neutral NV12 (luma 0x00, chroma 0x80) so GPU sampling
        // beyond the valid frame area (alignment / bilinear bleed) shows no green artifacts.
        {
