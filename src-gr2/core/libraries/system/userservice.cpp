...
// GR2FORK: the user service is backed by UserManager / UserSettings (users.json). UserManagement
// owns the default accounts 1000..1003 and the logged-in slots; a login for the default user
// (player_index 1 == user 1000) is queued at boot, so games observe one user under <home>/<uid>/.
