...
// GR2FORK FIX: SSA variable family for the per-lane (U1) view of a thread mask spilled into a
// VGPR lane via V_WRITELANE_B32 / V_READLANE_B32, keyed by (vgpr << 6) | lane. Inherits FlagTag
// so UndefOpcode(FlagTag) -> UndefU1 applies. See Translator::V_WRITELANE_B32.
