...
Block::iterator Block::PrependNewInst(iterator insertion_point, Opcode op,
    ...
    // GR2FORK PERF: plain index loop instead of ranges::for_each with a mutable lambda - no
    // closure object, and SetArg is called directly, which is easier for the optimizer to inline.
