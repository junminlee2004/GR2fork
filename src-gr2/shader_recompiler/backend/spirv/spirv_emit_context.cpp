...
Id ImageType(EmitContext& ctx, const ImageResource& desc, Id sampled_type) {
    ...
    const auto type = image.GetViewType(desc.is_array, desc.is_raw_access);
...
void EmitContext::DefineImagesAndSamplers() {
    for (const auto& image_desc : info.images) {
        ...
        // PORT(upstream #4075): mip-fallback pointee may be an array of images.
        ...
        images.push_back({
            ...
            .view_type = sharp.GetViewType(image_desc.is_array, image_desc.is_raw_access),
