...
private:
    // All currently-opened SDL gamepads. gr2fork opens every connected pad so any controller
    // can drive the game; m_gamepad (base Engine) points at the primary one (imgui nav / LED
    // focus) and ReadState coalesces input across all pads.
