...
private:
    // All currently-opened SDL gamepads. gr2fork opens every connected pad so any
    // controller can drive the game; m_gamepad (base Engine) points at the primary
    // one (used for imgui nav / LED focus). Input across all pads is coalesced in
    // ReadState.
