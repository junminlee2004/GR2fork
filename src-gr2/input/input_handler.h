...
// Synthetic touchpad-swipe outputs, bindable like buttons. A rising edge fires a timed sequence:
// touch down at (0.5, 0.5) with the TouchPad button, move to the direction endpoint after
// `touchpad_swipe_button_delay` (default 200ms), then release.
