...
vk::Format SurfaceFormat(AmdGpu::DataFormat data_format, AmdGpu::NumberFormat num_format) {
    ...
    // Unknown (data_format, num_format) combo - GR2 boss-fight T#s carry reserved num_format
    // encodings (8, 14, 15) and Format32_As_* with no direct Vulkan analog. Substitute a same-
    // storage-size format (the shader's own typing drives interpretation); dedupe the warning.
