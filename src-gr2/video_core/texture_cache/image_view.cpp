...
ImageView::ImageView(const Vulkan::Instance& instance, const ImageViewInfo& info_,
    ...
    // Last-resort guard (Bloodborne, VUID-VkImageViewCreateInfo-image-01003): an eCube view of
    // an image created without eCubeCompatible is invalid usage. Downgrade to e2DArray -
    // sampling is wrong for this binding (the shader expects Dim=Cube) but the API stays valid.
