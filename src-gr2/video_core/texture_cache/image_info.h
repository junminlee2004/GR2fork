...
struct ImageProperties {
    ...
    u32 has_stencil : 1;
    u32 is_cube : 1;
    // Set once in Image::Image from the FINAL VkImageCreateInfo flags: the image
    // was created with eCubeCompatible and can legally back an eCube view. Not
    // part of any cache key or hash; consumed by the ImageView downgrade guard.
    u32 is_cube_capable : 1;
};
