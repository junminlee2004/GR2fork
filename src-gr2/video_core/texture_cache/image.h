...
public:
    ...
    u64 lru_id{};
    // GR2FORK T-MIRROR (2026-06-10): gc_tick of the last LRU touch, mirrored
    // onto the Image so TextureCache::TouchImage can early-out on this warm
    // field instead of chasing lru_id through the LRU item_pool deque's
    // double indirection. Maintained by RegisterImage + TouchImage only.
    u64 lru_touch_tick{};
