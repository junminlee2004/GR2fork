...
// Non-fatal binary-info search - returns nullptr instead of aborting when the scan window has
// no valid BinaryInfo: a stage's program pointer can be stale or point at streamed-over guest
// memory with no "OrbShdr" footer. The asserting SearchBinaryInfo covers must-succeed paths.
