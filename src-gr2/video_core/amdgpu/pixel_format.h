...
// GR2FORK PERF: LUT accessors live in the header so the array load inlines and constant-folds
// when the format is known at compile time; the BindTextures / FindImage paths hit these hot.
namespace detail {
